   ...
   <div class="container-fluid px-md-5">
         ...
         <div class="col-md-3 mb-4">
            <div class="firstColumn">
               <div class="contactInfo">
                  <h2>REGISTER <span class="d-md-block"> YOUR </span> INTEREST</h2>
               </div>
            </div>
         </div>
         <div class="col-md-7 mb-4">
            <div class="footerLogo mb-5 pb-4">
               <a href="https://aibitbyte.com/pearlshire/"><img src="assets/images/logo.png"></a>
            </div>
            <div class="formData">
               <form>
                  <div class="row">
                     <div class="col-md-6 mb-4">
                        <div class="form-group">
                           <input type="text" class="form-control mw-100" placeholder="First Name*" required>
                        </div>
                     </div>
                     <div class="col-md-6 mb-4">
                        <div class="form-group">
                           <input type="text" class="form-control mw-100" placeholder="Last Name*" required>
                        </div>
                     </div>
                     <div class="col-md-6 mb-4">
                        <div class="form-group">
                           <input type="email" class="form-control mw-100" placeholder="Email*" required>
                        </div>
                     </div>
                     <div class="col-md-6 mb-4">
                        <div class="form-group">
                           <input type="text" class="form-control mw-100" placeholder="Phone*" required>
                        </div>
                     </div>
      ...
      <div class="footerBottom">
         <div class="row justify-content-between align-items-center">
            <div class="col-md-7 mb-4">
               <div class="bottomBard">
                  <div class="singleBox">
                     <div class="copyRight">
                        <p class="mb-0">© 2024 Pearlshire By Dubai Holding Real Estate.</p>
                     </div>
            ...
            <div class="col-md-5 mb-4">
               <div class="SocialLinks contacts__item mb-md-0 justify-content-end mt-md-0">
