<!DOCTYPE html>
<html>
<title>Guiding Principles - PearlShire </title>
  ...
  <section class="about_section">
    <div class="DefaultPageHeaderDesktop mounted">
      ...
      <div class="DefaultPageHeaderDesktop__image">
        ...
        <h1 class="DefaultPageHeaderDesktop__title">Guiding Principles</h1>
        <div class="container">
          ...
          <h2 class="DefaultPageHeaderDesktop__sub-title">Upholding Success<br>Our Core Principles</h2>
        </div>
